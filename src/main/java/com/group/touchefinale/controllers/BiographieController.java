...
public class BiographieController {
	...
	public String validation_formulaire_biographie(Biographie biographie, Model model) {
	...
	public String liste_artistes(Model model, @RequestParam(name = "pageRP", defaultValue = "0") int page,
		...
		Page<Biographie> listeDesBiographies = biographieRepository.chercherBiographies("%" + motcle + "%",
