...
@Controller
public class MenuPrincipalAmeriqueController {
	...
	/*------------------------------------------------------------------------------------*/
	/*
	 * @RequestMapping(value="/amerique") public String menu_principal_europe(Model
	 * model) {
	 * 
	 * List<Evenement> listeEvenementAVenir =
	 * evenementRepository.prochainevenement("amerique", new Date());
	 ...
	 * evenementRepository.evenementpasse("amerique", new Date());
	 ...
	 * 
	 * 
	 * return "front_end/fe_amerique_menu_principal/menuPrincipalAmerique";
	 * 
	 * }
	 */
}
